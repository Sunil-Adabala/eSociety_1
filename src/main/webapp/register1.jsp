...
<div class="container-fluid" style="margin-top: 30px;">
    ...
    <div class="row col-lg-4 col-lg-offset-4" style="margin-top: 40px; background-color: #fff; padding: 20px; border: solid 1px #ddd;">
        <form autocomplete="off" action="register"  th:object="${user}" method="post" class="form-signin" role="form">
            <h3 class="form-signin-heading">Registration Form</h3>
            <div class="form-group">
                <div class="">
                    <input type="text" th:field="*{name}" placeholder="User Name" class="form-control" />
                </div>
            </div>
<%--            <div class="form-group">--%>
<%--                <div class="">--%>
...
<%--            </div>--%>
            ...
            <div class="form-group">
                <div class="">
                    <input type="text" th:th:field="*{email}" placeholder="Society_id" class="form-control" />
                </div>
            </div>
            <div class="form-group">
                <div class="">
