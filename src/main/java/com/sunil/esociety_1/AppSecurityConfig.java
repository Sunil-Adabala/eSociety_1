...
//
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http.authorizeRequests()
                ...
                .antMatchers("/addmanagernew").hasAuthority("ADMIN")
                .antMatchers("/addsociety").hasAuthority("ADMIN")
                .antMatchers("/addmonthlyactivity").hasAnyAuthority("ADMIN","MANAGER")
                .antMatchers("/addyearlyactivity").hasAnyAuthority("ADMIN","MANAGER")
                .antMatchers("/reports/**").hasAnyAuthority("ADMIN","MANAGER")
